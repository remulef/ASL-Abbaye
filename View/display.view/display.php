    ...
    <main class="main">
        <span id="content" class="content">
            ...
            <div id="listdoc">
                ...
                <p style="font-style: italic; justify-content: center; font-size:1.5em;">Vous pouvez rechercher dans l'ensemble de la Base de données à partir du pavé de recherche à gauche OU rechercher par thématiques à partir des capsules ci-dessus</p>
                <ul id="docbar">
                </ul>
            </div>
        </span>
