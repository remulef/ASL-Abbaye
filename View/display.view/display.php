...
<header>
    ...
    <div>
        ...
        <a id="hider" onclick="hide()" class="button1">
            <svg class="bi bi-arrow-bar-left" width="3em" height="3em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
