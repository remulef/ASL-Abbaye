          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <div type="text"><?php echo $donnees['username']; ?></div>
                </td>
                <td><input type="text" name="" value="<?php echo $donnees['password']; ?>" style="display:none">
                  <div><?php echo $donnees['password']; ?></div>
                </td>
                <td>
